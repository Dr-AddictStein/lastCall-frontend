...
function Community() {
  return (
    <div
      className="flex justify-around items-center flex-col lg:flex-row mt-4 mb-20 px-4 lg:px-20"
      style={{
        backgroundImage: `url(${bgImg})`,
        backgroundSize: "cover",
        // transform: "rotate(90deg)", // Rotate the background image
      }}
    >
      <div className="flex justify-center gap-9 items-center">
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="bg-yellow-500 w-[1px]  h-[260px]"></div>
        </div>
        <div>
